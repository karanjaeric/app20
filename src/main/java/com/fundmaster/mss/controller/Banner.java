...
@MultipartConfig
public class Banner extends HttpServlet implements Serializable {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		com.fundmaster.mss.model.Banner bn = helper.getBannerById(helper.toLong(request.getPathInfo().substring(1)));
