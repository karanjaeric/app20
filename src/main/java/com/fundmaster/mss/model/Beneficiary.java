...
public class Beneficiary implements Serializable{
	...
	String relationship, relShipCategory, surname, firstname, othernames, dob, gender, monthlyEntitlement, lumpsumEntitlement, idNo, postalAddress, mstatus, physicalCondition, dateOfAppointment, birthCert, guardianSn, guardianFn, guardianOn, guardianAddr, guardianGender, status, guardianRelation;
