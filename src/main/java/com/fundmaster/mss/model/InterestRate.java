...
public class InterestRate extends GenericModel<InterestRate> implements Serializable{
	...
	Long id;
	String dateDeclared, year, contributions, openingBalances, pensionDrawnDown, counter, accountingPeriod, status, sponsor, type;
