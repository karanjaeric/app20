...
public class InterestRateColumns extends GenericModel<InterestRateColumns> implements Serializable {
	...
	Long id;
	boolean dateDeclared, year, contributions, openingBalances, pensionDrawDown, accountingPeriod;
	String dateDeclaredText, yearText, contributionsText, openingBalancesText, pensionDrawDownText, accountingPeriodText;
