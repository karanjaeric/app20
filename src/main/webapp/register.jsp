	 ...
	 <input type="hidden" name="hidCaptchaID" id="hidCaptchaID" value="<%= session.getId() %>"/>
			          ...
			          <ul class="nav nav-tabs tabs-left">
						<c:forEach var="field" items="${loginFields}">
			            	<c:if test="${ field.published }">
				            	<c:if test="${ count == 0 }">
				            		<li class="active"><a href="#${field.profile }" data-toggle="tab">${ field.profile }</a></li>
				            	</c:if>
				            	<c:if test="${ count > 0 }">
				            		<li><a href="#${field.profile }" data-toggle="tab">${ field.profile }</a></li>
				            	</c:if>
			            ...
			            <div class="tab-pane" id="SPONSOR">
				            <div class="row">
								...
								<div class="modal-dialog large-modal">
									<div class="modal-content">
										<div class="modal-body">
											<h2 class="heading">SPONSOR REGISTRATION</h2>
			            ...
			            <div class="tab-pane" id="TRUSTEE">						
							<div class="row">
								...
								<div class="modal-dialog large-modal">
									<div class="modal-content">
										<div class="modal-body">
											<h2 class="heading">TRUSTEE REGISTRATION</h2>
						...
						<div class="tab-pane" id="AGENT">						
							<div class="row">
								...
								<div class="modal-dialog large-modal">
									<div class="modal-content">
										<div class="modal-body">
											<h2 class="heading">AGENT REGISTRATION</h2>
						...
						<div class="tab-pane" id="CUSTODIAN">						
							<div class="row">
								...
								<div class="modal-dialog large-modal">
									<div class="modal-content">
										<div class="modal-body">
											<h2 class="heading">CUSTODIAN REGISTRATION</h2>
						...
						<div class="tab-pane" id="CUSTOMER_RELATIONSHIP_MANAGER">						
							<div class="row">
								...
								<div class="modal-dialog large-modal">
									<div class="modal-content">
										<div class="modal-body">
											<h2 class="heading">CUSTOMER REL/SHIP MANAGER REGISTRATION</h2>
						...
						<div class="tab-pane" id="CUSTOMER_RELATIONSHIP_EXECUTIVE">						
							<div class="row">
								...
								<div class="modal-dialog large-modal">
									<div class="modal-content">
										<div class="modal-body">
											<h2 class="heading">CUSTOMER REL/SHIP EXECUTIVE REGISTRATION</h2>
						...
						<div class="tab-pane" id="FUND_MANAGER">						
							<div class="row">
								...
								<div class="modal-dialog large-modal">
									<div class="modal-content">
										<div class="modal-body">
											<h2 class="heading">FUND MANAGER REGISTRATION</h2>
						...
						<div class="tab-pane" id="PENSIONER">						
							<div class="row">
								...
								<div class="modal-dialog large-modal">
									<div class="modal-content">
										<div class="modal-body">
											<h2 class="heading">PENSIONER REGISTRATION</h2>
			...
			<div id="company" class="tab-pane fade in">
								...
								<div class="modal-dialog large-modal">
									<div class="modal-content">
										<div class="modal-body">
											<h1 class="heading">NEW SPONSOR REGISTRATION</h1>
