...
<div class="container-fluid section">
    <div class="col-md-4">
        <h3>
            <i class="glyphicon glyphicon-user"></i>&nbsp;&nbsp;Calculator log
        </h3>
    </div>
    <!--
    ...
    <table class="table table-responsive table-striped" id="search-results">
        <tr><th>Date</th><th>Email</th><th>Phone</th><th>Contribution</th><th>Projection Age</th></tr>
        <c:forEach var="calclog" items="${ calclogs }">
            <tr><td>${calclog.requestdate }</td><td>${ calclog.email }</td><td>${ calclog.phone }</td><td>${ calclog.mothnlycontrib }</td><td>${ calclog.projectedage }</td></tr>
        </c:forEach>
    </table>
