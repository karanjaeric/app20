...
<div class="container-fluid section">
				<table class="table table-responsive table-striped">
					...
					<tr><td class="right">NAME:</td><td class="left">${ member.firstname } ${ member.lastname }  ${ member.othernames }</td><td class="right">EMAIL ADDRESS:</td><td class="left">${member.emailAddress }</td></tr>
