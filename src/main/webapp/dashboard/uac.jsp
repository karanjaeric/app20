	...
	.on('success.form.bv', function(e) {
    		...
    		$.ajax({
    	        ...
    	        data: {ACTION: 'SAVE_PERMISSION', profile: prof, setup_company: $('#setup_company').prop('checked'), setup_email: $('#setup_email').prop('checked'), setup_logo: $('#setup_logo').prop('checked'),
					...
					operation_benefit_projection: $('#operation_benefit_projection').prop('checked'), operation_claim_status: $('#operation_claim_status').prop('checked'), operation_annual_contribution: $('#operation_annual_contribution').prop('checked'),media_upload: $('#media_upload').prop('checked'), media_remove: $('#media_remove').prop('checked'),
					profile_names: $('#profile_names').prop('checked'),client_names: $('#client_names').prop('checked'), profile_privileges: $('#profile_privileges').prop('checked'), member_edit_permissions: $('#member_edit_permissions').prop('checked'), show_db_contribution_graph: $('#show_db_contribution_graph').prop('checked'),
					profile_login_username: $('#profile_login_username').prop('checked'),client_setup_config: $('#client_setup_config').prop('checked'), scheme_managers: $('#scheme_managers').prop('checked'), content_help: $('#content_help').prop('checked'),
					content_page: $('#content_page').prop('checked'), faq_page: $('#faq_page').prop('checked'), setup: $('#setup').prop('checked'), content: $('#content').prop('checked'), schemes: $('#schemes').prop('checked'), member_menu_config: $('#member_menu_config').prop('checked'), pensioner_menu_config: $('#pensioner_menu_config').prop('checked'),
					member_dashboard_items: $('#member_dashboard_items').prop('checked'), admin_dashboard_items: $('#admin_dashboard_items').prop('checked'),
					receipts: $('#receipts').prop('checked'), payments: $('#payments').prop('checked'), memberpayments: $('#memberpayments').prop('checked'), members: $('#members').prop('checked'), member_operations: $('#member_operations').prop('checked'),
					withdrawal_statement: $('#withdrawal_statement').prop('checked'), media: $('#media').prop('checked'), uac: $('#uac').prop('checked'), analytics: $('#analytics').prop('checked'),benefitProjectionPage: $('#benefitProjectionPage').prop('checked') ,sponsorBenefitProjectionPage: $('#sponsorBenefitProjectionPage').prop('checked'),calculator_log: $('#calculator_log').prop('checked'),
					...
					member_movement: $('#member_movement').prop('checked'), member_listing: $('#member_listing').prop('checked'), corporate_statement: $('#corporate_statement').prop('checked'), fund_movement: $('#fund_movement').prop('checked'), receipt_summary: $('#receipt_summary').prop('checked'),  pending_contribution: $('#pending_contribution').prop('checked'), portal_member_delete: $('#portal_member_delete').prop('checked'),
