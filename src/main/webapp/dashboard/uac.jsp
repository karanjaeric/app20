...
$(document).ready(function(){
	...
	.on('success.form.bv', function(e) {
    		...
    		$.ajax({
    	        url: $('#base_url').val() + 'admin',
    	        type: 'post',
    	        data: {ACTION: 'SAVE_PERMISSION', profile: prof, setup_company: $('#setup_company').prop('checked'), setup_logo: $('#setup_logo').prop('checked'), setup_menu: $('#setup_menu').prop('checked'), setup_social: $('#setup_social').prop('checked'), setup_theme: $('#setup_theme').prop('checked'), setup_banner: $('#setup_banner').prop('checked'), setup_interest_rate: $('#setup_interest_rate').prop('checked'), setup_other: $('#setup_other').prop('checked'), setup_contact_reason: $('#setup_contact_reason').prop('checked'), member_edit: $('#member_edit').prop('checked'), member_view: $('#member_view').prop('checked'), operation_personal_info: $('#operation_personal_info').prop('checked'), operation_contribution_history: $('#operation_contribution_history').prop('checked'), operation_balance_history: $('#operation_balance_history').prop('checked'), operation_statement_of_account: $('#operation_statement_of_account').prop('checked'), operation_benefit_projection: $('#operation_benefit_projection').prop('checked'), media_upload: $('#media_upload').prop('checked'), media_remove: $('#media_remove').prop('checked'), profile_names: $('#profile_names').prop('checked'), profile_privileges: $('#profile_privileges').prop('checked'), member_edit_permissions: $('#member_edit_permissions').prop('checked'), profile_login_username: $('#profile_login_username').prop('checked'), scheme_managers: $('#scheme_managers').prop('checked'), content_help: $('#content_help').prop('checked'), content_page: $('#content_page').prop('checked'), setup: $('#setup').prop('checked'), content: $('#content').prop('checked'), schemes: $('#schemes').prop('checked'), receipts: $('#receipts').prop('checked'), payments: $('#payments').prop('checked'), members: $('#members').prop('checked'), member_operations: $('#member_operations').prop('checked'), media: $('#media').prop('checked'), uac: $('#uac').prop('checked'), analytics: $('#analytics').prop('checked'), users: $('#users').prop('checked'), user_enable_disable: $('#user_enable_disable').prop('checked'), audit_trail: $('#audit_trail').prop('checked'), portal_member_add: $('#portal_member_add').prop('checked'), portal_member_view: $('#portal_member_view').prop('checked'), portal_member_delete: $('#portal_member_delete').prop('checked'), portal_member_process: $('#portal_member_process').prop('checked'), portal_sponsor_add: $('#portal_sponsor_add').prop('checked'), portal_sponsor_view: $('#portal_sponsor_view').prop('checked'), portal_sponsor_delete: $('#portal_sponsor_delete').prop('checked'), portal_sponsor_process: $('#portal_sponsor_process').prop('checked'), portal_members: $('#portal_members').prop('checked'), portal_sponsors: $('#portal_sponsors').prop('checked'), password_policy: $('#password_policy').prop('checked') },
    	        dataType: 'json',
