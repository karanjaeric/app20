	...
	.on('success.form.bv', function(e) {
    		...
    		$.ajax({
    	        ...
    	        data: {ACTION: 'SAVE_PERMISSION', profile: prof, setup_company: $('#setup_company').prop('checked'), setup_email: $('#setup_email').prop('checked'), setup_logo: $('#setup_logo').prop('checked'),
					...
					member_movement: $('#member_movement').prop('checked'), fund_movement: $('#fund_movement').prop('checked'), receipt_summary: $('#receipt_summary').prop('checked'), portal_member_delete: $('#portal_member_delete').prop('checked'),
