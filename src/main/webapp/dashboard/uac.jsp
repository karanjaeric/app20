	...
	.on('success.form.bv', function(e) {
    		...
    		$.ajax({
    	        ...
    	        data: {ACTION: 'SAVE_PERMISSION', profile: prof, setup_company: $('#setup_company').prop('checked'), setup_email: $('#setup_email').prop('checked'), setup_logo: $('#setup_logo').prop('checked'),
					...
					content_page: $('#content_page').prop('checked'), setup: $('#setup').prop('checked'), content: $('#content').prop('checked'), schemes: $('#schemes').prop('checked'), member_menu_config: $('#member_menu_config').prop('checked'), member_dashboard_items: $('#member_dashboard_items').prop('checked'),
