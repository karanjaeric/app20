	...
	.on('success.form.bv', function(e) {
    		...
    		$.ajax({
    	        ...
    	        data: {ACTION: 'SAVE_PERMISSION', profile: prof, setup_company: $('#setup_company').prop('checked'), setup_email: $('#setup_email').prop('checked'), setup_logo: $('#setup_logo').prop('checked'),
					...
					withdrawal_statement: $('#withdrawal_statement').prop('checked'), media: $('#media').prop('checked'), uac: $('#uac').prop('checked'), analytics: $('#analytics').prop('checked'),benefitProjectionPage: $('#benefitProjectionPage').prop('checked') ,calculator_log: $('#calculator_log').prop('checked'),
