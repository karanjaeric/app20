	...
	.on('success.form.bv', function(e) {
    		...
    		$.ajax({
    	        ...
    	        data: {ACTION: 'SAVE_PERMISSION', profile: prof, setup_company: $('#setup_company').prop('checked'), setup_logo: $('#setup_logo').prop('checked'),
					...
					profile_names: $('#profile_names').prop('checked'), profile_privileges: $('#profile_privileges').prop('checked'), member_edit_permissions: $('#member_edit_permissions').prop('checked'),
					...
					withdrawal_statement: $('#withdrawal_statement').prop('checked'), media: $('#media').prop('checked'), uac: $('#uac').prop('checked'), analytics: $('#analytics').prop('checked'),
					...
					audit_trail: $('#audit_trail').prop('checked'), portal_member_add: $('#portal_member_add').prop('checked'), portal_member_view: $('#portal_member_view').prop('checked'), member_movement: $('#member_movement').prop('checked'),
					portal_member_delete: $('#portal_member_delete').prop('checked'), portal_member_process: $('#portal_member_process').prop('checked'),
